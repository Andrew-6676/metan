...
?>
	<div class="rep_wrapper">
		<div class="rekvizit" style="height: 75px;">
			<div class="post"  style="float: left" width="40%" >
				<table class="no_border">
					...
					<tr>
						<td>
							Идентификационный номер покупателя (ИНН): <?php echo Store::model()->findByPk($_GET['id_store'])->storepassports[0]->unn; ?>
						</td>
					</tr>
					<tr>
						<td>
							Код ОКПО: <?php echo Store::model()->findByPk($_GET['id_store'])->storepassports[0]->okpo; ?>
						</td>
					</tr>
				</table>
			</div>
		...
		<div class="report_title">
			СЧЁТ-ФАКТУРА № <?php echo $data['rec_doc']->doc_num; ?> от <?php echo Utils::format_date($data['rec_doc']->doc_date); ?>
		</div>
	</div>
<?php
//	Utils::print_r($_GET);
