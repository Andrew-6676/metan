...
<!--				</colgroup>-->
				...
				<tbody>
					...
					foreach ($rec_doc_data as $row) {
						...
						$tr .=    "</td>";
						$tr .=    "<td>";
						$tr .=          number_format((($row->markup/100+1)*$row->cost), '2','.',' ');
						$tr .=    "</td>";
						$tr .=    "<td>";
						$tr .=          number_format(($row->markup/100+1)*$row->cost*$row->quantity, '2','.',' ');
						$tr .=    "</td>";
						$tr .=    "<td>";
						$tr .=          $row->vat;
						$tr .=    "</td>";
						$tr .=    "<td>";
						$tr .=          number_format((($row->vat/100)*($row->markup/100+1)*$row->cost*$row->quantity), '2','.'," ");
						$tr .=    "</td>";
						$tr .=    "<td>";
						$tr .=          number_format((($row->vat/100+1)*($row->markup/100+1)*$row->cost), '2','.'," ");
						$tr .=    "</td>";
						$tr .=    "<td>";
...
//					$tr .=          $row->markup;
					...
					$tr .=    "</td>";
					$tr .=    "<td>";
					$tr .=          number_format($rec_doc->sum_with_markup, '2','.',' ');
					$tr .=    "</td>";
					$tr .=    "<td>";
//					$tr .=          $row->vat;
					$tr .=    "</td>";
					$tr .=    "<td>";
					$tr .=          number_format($rec_doc->sum_vat, '2','.',' ');
					$tr .=    "</td>";
					$tr .=    "<td>";
//					$tr .=          number_format((($row->vat/100+1)*($row->markup/100+1)*$row->cost), '2','.'," ");
					$tr .=    "</td>";
...
//					$tr .=          number_format(($row->price), '2','.'," ");
					$tr .=    "</td>";
					$tr .=    "<td>";
					$tr .=          number_format(($rec_doc->sum_price), '2','.'," ");
					$tr .=    "</td>";
					$tr .= "</tr>";
						// ВСЕГО
					echo $tr;
					...
					$tr .=    "</td>";
					$tr .=    "<td>";
					$tr .=          number_format($rec_doc->sum_cost, '2','.',' ');
					$tr .=    "</td>";
					$tr .=    "<td>";
					//					$tr .=          $row->vat;
					$tr .=    "</td>";
...
//					$tr .=          number_format(($rec_doc->sum_price), '2','.'," ");
					...
					$tr .=    "</td>";
					$tr .=    "<td>";
					$tr .=          number_format($rec_doc->sum_markup, '2','.',' ');
					$tr .=    "</td>";
					$tr .=    "<td>";
					//					$tr .=          $row->vat;
					$tr .=    "</td>";
