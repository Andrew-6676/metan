...
<!--			<td class="no_border"></td>-->
		...
		foreach ($data as $id_op=>$op) {
			...
			$tr .=   '</th>';
			$tr .=   '<td>';
			$tr .=       number_format(@$op[1], '2', '.', '&nbsp;');
			$tr .=   '</td>';
			$tr .=   '<td>';
			$tr .=       number_format(@$op[2], '2', '.', '&nbsp;');
			$tr .=   '</td>';
			$tr .=   '<td>';
			$tr .=       number_format(@$op[3], '2', '.', '&nbsp;');
			$tr .=   '</td>';
			$tr .=   '<td>';
			$tr .=       '<b>'.number_format(@$op[0], '2', '.', '&nbsp;').'<b>';
			$tr .=   '</td>';
			$tr .= '</tr>';
		...
		$tr .=   '</th>';
		$tr .=   '<td>';
		$tr .=       '<b>'.number_format($s[1], '2', '.', '&nbsp;').'<b>';
		$tr .=   '</td>';
		$tr .=   '<td>';
		$tr .=       '<b>'.number_format($s[2], '2', '.', '&nbsp;').'<b>';
		$tr .=   '</td>';
		$tr .=   '<td>';
		$tr .=       '<b>'.number_format($s[3], '2', '.', '&nbsp;').'<b>';
		$tr .=   '</td>';
		$tr .=   '<td><b>';
		$tr .=       number_format($s[0], '2', '.', '&nbsp;');
		$tr .=   '</td></b>';
		$tr .= '</tr>';
		echo $tr;
