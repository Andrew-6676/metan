...
//CPagination
			...
			echo '<button id="cancel_all">Отменить все изменения</button><br><br>';
			echo '<table class="editRest" tname=' . $this->model[0]->tableName() . '>';
			echo '<thead>';
			echo '<tr>
				<th></th>
				<th><a href="?sort=id_goods">Код</a></th>
				<th><a href="?sort=t1_c1">Наименование</a></th>
				<th>Ед.изм.</th>
				<th><a href="?sort=price">Цена</a></th>
				<th><a href="?sort=quantity">Остаток</a></th>
			</tr>';
			echo '</thead>';
