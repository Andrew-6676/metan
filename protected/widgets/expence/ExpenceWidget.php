...
class ExpenceWidget extends CWidget
{
    ...
    public function init()
    {
        ...
        $cssFile='http://'.$_SERVER['HTTP_HOST'].'/metan_0.1/css/widgets/expence/'.'doc.css';
        $jsFile='http://'.$_SERVER['HTTP_HOST'].'/metan_0.1/js/widgets/expence/'.'doc.js';
    		...
    		echo '<thead>';
    			echo '<tr id="doc_hat_'.$doc->id.'" class="doc_hat">';
    				...
    				echo '<td colspan="10">';
						...
						echo '<br><span class="capt"></span><span>'.$doc->idOperation->name.'</span>';
